...
```python
from insert_data, get_data import crud
...
Continuamos con la 3° operación cr**U**d, definiremos una función que permite actualizar el campo `model` de la tabla:
...
```python
from insert_data, get_data, update_data import crud
...
```python
from insert_data, get_data, update_data, delete_data import crud
