---
title: "Python 🐍 : Estructuras Repetitivas Bucles (FOR y WHILE)"
author: enidev911
categories: [Python, "01. Básico"]
mermaid: true
---

Después de aprender a tomar decisiones en función una o más condiciones con las __estructuras condicionales__, como el __`if`__, __`elif`__ y __`else`__, ahora veremos cómo podemos __repetir acciones__ utilizando __estructuras repetitivas__ o "bucles".
...
### __¿Cómo funciona el bucle WHILE?__
...
> Un error común cuando se usa `while` es __olvidar inicializar o actualizar adecuadamente la variable que controla la condición__. Si la condición nunca cambia a __`False`__, el bucle se __ejecutará indefinidamente__, generando lo que se conoce como un __bucle infinito__.
{: .prompt-warning }
...
### __¿Cómo funciona el bucle FOR?__
