---
title: "CSS Preferencias de usuario"
categories: [Desarrollo Web, CSS]
icon: "modern-css"
image:
    path: posters/css-preferencias-de-usuario.webp
...
Cuando trabajamos con las _medias queries_ no solo es para adaptar estilos a diferentes tamaños de pantalla, estas también nos permiten tener en cuenta las __preferencias del usuario__ definidas en su sistema operativo o navegador. Estas reglas especiales con `@media` nos permiten personalizar la experiencia según condiciones como el modo oscuro, la reducción de movimiento o el contraste elevado, respetando así las necesidades o gustos del usuario.
