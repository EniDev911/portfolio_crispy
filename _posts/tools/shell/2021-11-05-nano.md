...
[**El editor Nano**](https://www.nano-editor.org/){:target='_blank'} (oficialmente GNU nano) es un ligero editor de texto de línea de comandos muy amigable. Aunque a simle vista parece una herramienta básica, ofrece funciones muy útiles y es una excelente opción para __editar archivos de configuración__, __crear scripts o lanzadores__.
...
_abrir archivo con cursor en paabra específica_
